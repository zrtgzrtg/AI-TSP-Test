...
def compare1(route1,route2,problem,type,savedir):
    ...
    plotGTSPRoutes(coords,clusters,route1,route2,savedir)
def plotGTSPRoutes(coords, clusters,route1, route2, savedir):
    plot_route(coords,route1, savedir, "routeLKH",problem_type="gtsp",clusters=clusters)
    plot_route(coords,route2, savedir, "routeAPI",problem_type="gtsp",clusters=clusters)
...
if __name__ == "__main__":
    ...
    ],[373, 442, 348, 92, 397, 299, 226, 405, 74, 205, 108, 387, 425, 268, 125, 169, 365, 355, 253, 179, 273, 68, 174, 117, 243, 31, 16, 53, 138, 222, 285, 131, 185, 432, 206, 203, 325, 294, 165, 289, 259, 124, 414, 171, 435, 344, 336, 212, 73, 145, 170, 240, 305, 258, 413, 52, 390, 278, 428, 349, 152, 192, 175, 101, 107, 123, 140, 159, 209, 407, 244, 239, 359, 248, 67, 75, 88, 215, 231, 311, 401, 114, 126, 307, 275, 431, 97, 85, 82, 95, 324, 398, 300, 291, 25, 7, 2, 12, 20],"99pcb442_added10","manual","plots")
