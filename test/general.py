...
if __name__ == "__main__":
    result = None
    #result = solve_gtsp("99pcb442_added10", "manual")

    if result is not None:
        dist_matrix = result["dist_matrix"]
    coords,clusters = manualProblem("99pcb442_added10", "manual")
    ...
    glkh_route_0_based =[
            51, 83, 141, 154, 177, 164, 176, 396, 212, 211, 228, 240, 239, 406,
            186, 174, 151, 391, 127, 116, 106, 99, 78, 44, 11, 8, 6, 5, 2, 1,
            441, 65, 101, 440, 148, 160, 399, 404, 238, 281, 427, 282, 423, 289,
            315, 314, 432, 347, 348, 351, 355, 358, 295, 277, 299, 324, 428, 362,
            363, 364, 368, 372, 335, 332, 331, 274, 419, 415, 217, 411, 258, 255,
            251, 250, 230, 214, 191, 143, 131, 132, 122, 123, 133, 169, 410, 413,
            183, 134, 124, 96, 30, 94, 93, 59, 24, 56, 86, 53, 19
        ] 
